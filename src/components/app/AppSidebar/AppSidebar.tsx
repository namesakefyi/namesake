...
export const AppSidebar = ({ header, children, footer }: AppSidebarProps) => {
  ...
  return (
    <div className="w-72 lg:w-80 xl:w-[22rem] flex flex-col shrink-0 sticky top-0 h-screen max-h-full align-self-stretch overflow-y-auto bg-sidebar border-r border-overlay">
