...
const segmentStyles = tv({
  base: "inline p-0.5 type-literal:px-0 rounded-sm outline outline-0 forced-color-adjust-none caret-transparent text-gray-normal forced-colors:text-[ButtonText]",
  variants: {
    isPlaceholder: {
