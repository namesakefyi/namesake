...
const skeletonStyles = tv({
  base: "w-full h-full relative animate-fade-in before:inset-0 before:absolute before:bg-graya-4 dark:before:bg-graydarka-4 before:rounded-sm before:animate-pulse",
  variants: {
    type: {
      circle: "rounded-full",
      text: "h-4",
