...
const styles = tv({
  extend: focusRing,
  base: "px-3.5 [&:has(svg:only-child)]:px-2 flex items-center justify-center gap-1.5 text-sm text-center font-medium transition rounded-lg border border-transparent relative isolate shrink-0",
  variants: {
    isSelected: {
