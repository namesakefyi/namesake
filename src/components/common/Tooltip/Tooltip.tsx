...
const styles = tv({
  base: "light group bg-white dark:bg-gray-5 text-gray-12 text-sm rounded-lg drop-shadow-lg will-change-transform px-3 py-1",
  variants: {
    isEntering: {
    ...
    >
      <OverlayArrow>
        <svg
          ...
          height={8}
          viewBox="0 0 8 8"
          className="fill-white dark:fill-gray-5 forced-colors:fill-[Canvas] group-placement-bottom:rotate-180 group-placement-left:-rotate-90 group-placement-right:rotate-90"
        >
