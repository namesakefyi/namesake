...
description: Namesake has a fresh coat of paint and a new app in the works. Eva Decker joins as co-founder.
...
![Illustrations of a driver's license, a gavel, a passport, a social security card, and a flower with snails.](./content-namesake-image.webp)
...
Government paperwork can often feel reductive and limiting; we want Namesake to support expressiveness and fluidity within an otherwise rigid system. You can view and download Namesake's new logo, font, and color palette on our [brand assets](https://namesake.fyi/brand-assets) page.
...
Speaking of Discord, today we're [launching our new Discord server](https://namesake.fyi/chat)! Our past name change clinics with MTPC have been more than just a way to get paperwork done—they've been powerful, fun spaces for community connection and support (thanks in no small part to our partners).

![Discord server preview](./content-discord-image.png)
