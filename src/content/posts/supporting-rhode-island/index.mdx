...
As part of making it easier for contributors to get involved, we launched the [Namesake Contributor Manual](https://docs.namesake.fyi)—a documentation site that details how our site is organized, how to set up a developer environment, and how to do common tasks like adding PDFs or editing guides.
