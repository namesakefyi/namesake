...
— Anonymous
<br />
![A graphic that looks like an early 2010s Xbox LIVE Gamertag sign-on notification where the user's name is FYIxNamesake](./mc.png)
...
— @starite.bsky.social
<br />
![A graphic that looks like an early 2010s Xbox LIVE Gamertag sign-on notification where the user's name is FYIxNamesake](./maple-1.png)
